...
def plot_results(vertices, solution, distance_over_time, distance_found, filename, shortest, algo, exval):
    ...
    plt.savefig(f"/home/patryksiutkowski/GitHub/EvolutionaryAlgorithmsChug/GeneticAlgorithm/Day4/{algo}_{name}_test_no_{exval}.png")
...
def animate_results(vertices, solutions_over_time, distance_over_time, distance_found, filename, shortest, algo, exval):
    ...
    output = f"/home/patryksiutkowski/GitHub/EvolutionaryAlgorithmsChug/Day4/{algo}_{name}_test_no_{exval}.mp4"

    ani.save(output, writer="ffmpeg", fps=10)

if __name__ == "__main__":
    vertices, demands, capacity = extract_data(filepath)
    ...
    animate_results(vertices, solutions_over_time, fitness_over_time, best_cost, filepath, shortest, algo="ga", exval=0)